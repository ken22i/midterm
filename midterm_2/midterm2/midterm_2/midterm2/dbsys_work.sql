...
(4, '電子學', 2, 2, 0, 60, 43, 402, 3),
(5, '密碼學', 1, 2, 1, 60, 44, 302, 3),
(7, '組合數學', 1, 2, 1, 60, 60, 503, 2),
(6, '編譯器', 1, 3, 1, 60, 53, 302, 3),
(8, '計算機概論', 2, 1, 0, 60, 57, 507, 3),
(9, '機率與統計', 1, 2, 0, 60, 45, 108, 3),
(10, '軟體測試', 1, 3, 1, 60, 48, 203, 3),
(11, '數位信號處理', 2, 3, 1, 60, 36, 207, 3),
(12, '電磁波', 2, 3, 1, 60, 30, 306, 3),
(3, '計算機概論', 1, 1, 0, 60, 56, 107, 3),
(13, '系統安全', 1, 3, 1, 60, 35, 108, 3),
(14, '寬頻網路', 1, 3, 1, 60, 57, 502, 3),
(15, '程式語言', 1, 3, 1, 60, 47, 307, 3),
(16, 'web程式設計', 1, 2, 1, 60, 58, 208, 3);
